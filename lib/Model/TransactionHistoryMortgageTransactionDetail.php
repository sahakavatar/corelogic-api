...
/**
 * TransactionHistoryMortgageTransactionDetail Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionHistoryMortgageTransactionDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransactionHistoryMortgageTransactionDetail';
     ...
     *
     * @param string $mortgage_type_code CoreLogic standardized mortgage classification for principal mortgages ('P'urchase, 'R'efinance) or subordinate mortgages ('J'unior).
     *
     * @return $this
     */
     ...
     *
     * @param string $subordinate_type_code CoreLogic standardized value indicating the type of subordinate mortgage secured. (e.g., 'C'redit Line, 'E'quity, Ba'L'loon)
     *
     * @return $this
     */
     ...
     *
     * @param string $subordinate_type_code_description CoreLogic standardized description indicating the type of subordinate mortgage secured. (e.g. Credit Line, Equity, Balloon).  Described value of subordinateTypeCodeDescription.
     *
     * @return $this
     */
