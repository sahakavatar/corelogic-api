 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Patio implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Patio';
     ...
     * Sets count
     *
     * @param int $count County provided number indicating how many patio areas the building includes.
     *
     * @return $this
     */
     ...
     * Sets type_code
     *
     * @param string $type_code CoreLogic standardized code that indicates the type of patio present in the building. Usually adjoining the building and can be constructed of concrete, cement, stone, brick pavers or a combination. Typically does not have a roof covering. Example: 10B = brick patio.
     *
     * @return $this
     */
     ...
     *
     * @param float $area_square_feet Total square footage for the primary patio or deck on the property.
     *
     * @return $this
     */
