...
/**
 * TransactionHistoryBuyerName Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionHistoryBuyerName implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransactionHistoryBuyerName';
     ...
     *
     * @param int $sequence_number If there are multiple buyers, the sequenceNumber begins with 1 for the first buyer and increases by one for each additional property buyer.
     *
     * @return $this
     */
     ...
     * Sets full_name
     *
     * @param string $full_name Full name of the buyer at the time of transfer.
     *
     * @return $this
     */
     ...
     * Sets last_name
     *
     * @param string $last_name Last name of the buyer.
     *
     * @return $this
     */
     ...
     *
     * @param string $first_name_and_middle_initial First Name and Middle Initial of the buyer.
     *
     * @return $this
     */
     ...
     * Sets is_corporate
     *
     * @param string $is_corporate Indicator that the buyer has been recognized as a corporation or business.
     *
     * @return $this
     */
