...
/**
 * LenderDetail Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LenderDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LenderDetail';
     ...
     *
     * @param string $lender_post_to_code Standardized grouped Lender Code when 2 or more Lender Name variations exist or when CoreLogic aggregates smaller lenders into a single group (Exp. 000252.)
     *
     * @return $this
     */
     ...
     *
     * @param string $lender_post_to_name Corresponding Lender Name that correlates with Lender Post-To Code. (Exp. 000252 matches to Other Institution Lenders.)
     *
     * @return $this
     */
