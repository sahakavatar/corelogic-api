...
class Pool implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Pool';
     ...
     * Sets type_code
     *
     * @param string $type_code Type of pool, construction or pool amenities (e.g., Kidney, Gunite, Vinyl, Jacuzzi, Heated).
     *
     * @return $this
     */
     ...
     *
     * @param float $area_square_feet Total square footage for the pool on the property.
     *
     * @return $this
     */
