...
class TransactionDetails implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'is_mortgage_purchase' => 'bool',
        'is_interfamily_related' => 'bool',
        'is_investor_purchase' => 'bool',
        'is_resale' => 'bool',
        'is_short_sale' => 'bool',
        'is_foreclosure_reo' => 'bool',
        'is_foreclosure_reo_sale' => 'bool'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'is_cash_purchase' => null,
        'is_mortgage_purchase' => null,
        'is_interfamily_related' => null,
        'is_investor_purchase' => null,
        'is_resale' => null,
        'is_short_sale' => null,
        'is_foreclosure_reo' => null,
        'is_foreclosure_reo_sale' => null
    ];
     ...
     *
     * @param string $sale_date_derived CoreLogic proprietary sale date derived from the original public record filing, representing the date that the Deed was prepared in advance of being notarized and prior to being recorded. Format: YYYY-MM-DD.
     *
     * @return $this
     */
     ...
     *
     * @param string $sale_recording_date_derived CoreLogic proprietary sale recording date derived from the original public record filing, representing the date the sales transaction was recorded at the county. This date is generally considered the transfer of ownership date. Format: YYYY-MM-DD.
     *
     * @return $this
     */
     ...
     *
     * @param string $multi_or_split_parcel_code Indicates either that the transaction involves multiple parcels, or the split of an existing parcel.
     *
     * @return $this
     */
     ...
     *
     * @param bool $is_cash_purchase CoreLogic proprietary value that identifies if the property was a cash-based arms-length transaction. 0 = not applicable, 1= applicable.
     *
     * @return $this
     */
     ...
     *
     * @param bool $is_mortgage_purchase CoreLogic proprietary value that identifies if the property has a mortgage. 0 = not applicable, 1= applicable.
     *
     * @return $this
     */
     ...
     *
     * @param bool $is_interfamily_related CoreLogic proprietary value that indicates if a potential relationship between the seller and the buyer of the property exists. This could be interfamily, intercompany, or trust transfer (non-arms length transaction).  0 = not applicable, 1= applicable.
     *
     * @return $this
     */
     ...
     *
     * @param bool $is_investor_purchase CoreLogic proprietary value that indicates if the buyer bought the property for investment purposes. 0 = not applicable, 1= applicable.
     *
     * @return $this
     */
     ...
     * Sets is_resale
     *
     * @param bool $is_resale CoreLogic standardized value that indicates whether the transaction is considered a resale of an existing property. 0 = not applicable, 1= applicable.
     *
     * @return $this
     */
     ...
     * Sets is_short_sale
     *
     * @param bool $is_short_sale CoreLogic proprietary indicator that identifies if the property sale is considered a short sale.  0 = not applicable, 1= applicable.
     *
     * @return $this
     */
     ...
     *
     * @param bool $is_foreclosure_reo CoreLogic proprietary value that indicates whether the transaction was a completed foreclosure where the bank took back ownership of the property (REO).  0 = not applicable, 1= applicable.
     *
     * @return $this
     */
     ...
     *
     * @param bool $is_foreclosure_reo_sale CoreLogic proprietary value that indicates that the bank sold the REO to a third party. 0 = not applicable, 1= applicable.
     *
     * @return $this
     */
