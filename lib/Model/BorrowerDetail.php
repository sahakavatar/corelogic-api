...
/**
 * BorrowerDetail Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BorrowerDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BorrowerDetail';
    ...
    protected static $swaggerTypes = [
        'borrowers' => '\Swagger\Client\Model\BorrowerNameDetail[]',
        'etal_code' => 'string',
     ...
     * Gets borrowers
     *
     * @return \Swagger\Client\Model\BorrowerNameDetail[]
     */
     ...
     * Sets borrowers
     *
     * @param \Swagger\Client\Model\BorrowerNameDetail[] $borrowers borrowers
     *
     * @return $this
     */
     ...
     *
     * @param string $ownership_rights_code_description Describes the value of the ownershipRightsCode.
     *
     * @return $this
     */
     ...
     *
     * @param string $relationship_type_code CoreLogic standardized code that indicates the type of vesting for current borrower or borrowers.
     *
     * @return $this
     */
