...
/**
 * BorrowerNameDetail Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BorrowerNameDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BorrowerNameDetail';
     ...
     * Sets sequence_id
     *
     * @param int $sequence_id The occurrence of the BORROWER.
     *
     * @return $this
     */
     ...
     *
     * @param string $borrower_full_name Full name of the BORROWER.
     *
     * @return $this
     */
     ...
     *
     * @param string $borrower_first_name First name of the BORROWER.
     *
     * @return $this
     */
     ...
     *
     * @param string $borrower_middle_initial Middle initial of the BORROWER.
     *
     * @return $this
     */
     ...
     *
     * @param string $borrower_last_name Last name of the BORROWER.
     *
     * @return $this
     */
