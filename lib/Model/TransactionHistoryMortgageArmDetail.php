...
/**
 * TransactionHistoryMortgageArmDetail Class Doc Comment
 *
 * @category Class
 * @description Mortgage Arm Details
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionHistoryMortgageArmDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransactionHistoryMortgageArmDetail';
     ...
     * Sets index_type
     *
     * @param string $index_type Indicates which index is used to determine the adjustable mortgage interest rate. Value Description SOF    SOFR LIB    LIBOR CMT    Constant Maturity Treasury MTA    Monthly Treasury Average LAM    LAMA PRM    Prime DIS    11th District BIL    Treasury Bill FNM    FNMA (Fannie Mae) OTH    Other
     *
     * @return $this
     */
     ...
     *
     * @param string $prepayment_rider_indicator CoreLogic standardized value that indicates if the mortgage loan contains a prepayment rider. 'Y' = Prepayment Rider present.
     *
     * @return $this
     */
