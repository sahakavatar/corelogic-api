...
/**
 * ClimateRiskAnalyticsAR6 Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClimateRiskAnalyticsAR6 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClimateRiskAnalyticsAR6';
    ...
    protected static $swaggerTypes = [
        ...
        'perils' => '\Swagger\Client\Model\ClimateRiskAR6Perils[]'
    ];
     ...
     * Sets latitude
     *
     * @param float $latitude CoreLogic proprietary parcel-centroid coordinate that specifies the north-south position of the center point of a parcel. The latitude contains numeric data values only conforming to the mask XX.ZZZZZZ, where the XX are the digits to the left of the decimal point, and ZZZZZZ are the digits to the right of the decimal point. Latitude is always a positive value on the North American continent.
     *
     * @return $this
     */
     ...
     * Sets longitude
     *
     * @param float $longitude CoreLogic proprietary parcel-centroid coordinate that specifies the east-west position of the center point of a parcel. The longitude contains numeric data values only conforming to the mask -XXX.ZZZZZZ, where the XXX are the numeric digits to the left of the decimal point, and ZZZZZZ are the 6 numeric digits to the right of the decimal point. Longitude is a negative value on the North American continent.
     *
     * @return $this
     */
     ...
     * Gets perils
     *
     * @return \Swagger\Client\Model\ClimateRiskAR6Perils[]
     */
     ...
     * Sets perils
     *
     * @param \Swagger\Client\Model\ClimateRiskAR6Perils[] $perils Peril Details
     *
     * @return $this
     */
