...
/**
 * MailingPropertyAddress Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MailingPropertyAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MailingPropertyAddress';
    ...
    {
        $this->container['care_of_name'] = isset($data['care_of_name']) ? $data['care_of_name'] : null;
     ...
     * Sets care_of_name
     *
     * @param string $care_of_name Care of Name for mail delivery.
     *
     * @return $this
     */
     ...
     * Sets street_address
     *
     * @param string $street_address Full mail address (not including City/St/Zip) (e.g. 123 N Main St). This also contains unparsed foreign mailing address.
     *
     * @return $this
     */
     ...
     * Sets city
     *
     * @param string $city The city associated with the mailing address.
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param string $state The two-letter USPS postal abbreviation associated with the state / protectorates / commonwealth (e.g., CA, VI, PR).
     *
     * @return $this
     */
