...
/**
 * AnnualExceedanceProbability Class Doc Comment
 *
 * @category Class
 * @description AnnualExceedanceProbablility Details
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AnnualExceedanceProbability implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AnnualExceedanceProbability';
     ...
     * Sets aep250
     *
     * @param float $aep250 250-Year Annual Exceedance Probability. Loss level with a 1-in-250 (0.4%) chance of being exceeded in any given year, based on the total losses each year.
     *
     * @return $this
     */
